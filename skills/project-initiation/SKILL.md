...
2. Write `<project-dir>/docs/spec.md`, preserving user requirements and
   recording unresolved questions rather than silently choosing scope.
...
3. If delegating, apply `supervising-delegated-work` and provide the worker
